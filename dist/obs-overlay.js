  ...
  _createClass(Overlay, [{
    ...
    value: function update() {
      ...
      for (var key in this.state) {
        ...
        try {
          for (var _iterator = this.querySelectorAll('[data-state=' + key + ']')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var ele = _step.value;
    ...
    value: function render(state) {
      (0, _litHtml.render)(Overlay.template(state), this.shadowRoot);
    }
  }]);
...
function (_HTMLElement2) {
  ...
  _createClass(Dock, [{
    ...
    key: "setup",
    value: function setup() {// setup dock
    }
  }, {
    key: "updateOverlay",
    ...
    key: "render",
    value: function render(state) {
      var styles = this.constructor.styles(state);
      var template = this.constructor.template(state);

      if (template) {
        (0, _litHtml.render)((0, _litHtml.html)(_templateObject2(), styles, template), this.shadowRoot);
      } else {
...
},{"lit-html":"node_modules/lit-html/lit-html.js"}],"C:/Users/tim/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/tim/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","obs-overlay.js"], null)
//# sourceMappingURL=/obs-overlay.js.map